...
coords=np.loadtxt('nodesC2', delimiter=',')
topo=np.loadtxt('elementsC2', delimiter=',')
loads=np.loadtxt('loadsC2', delimiter=',')
BC=np.loadtxt('bcelesC2', delimiter=',')
...
# plt.figure(1)
UVAB=np.loadtxt('UABQCantilever2')
...
SAB=np.loadtxt('SABQCantilever2')
